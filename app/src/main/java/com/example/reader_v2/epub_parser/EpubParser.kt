...
class EpubParser @Inject constructor(
	...
	suspend fun parse(inputStream: InputStream) = withContext(Dispatchers.Default) {
		...
		val manifestItems: Map<String, EpubBook.ManifestItem> = manifest.children().map {
		...
		val chapters: List<EpubBook.Chapter> = chapterParser.parse(
