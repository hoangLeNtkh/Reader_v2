...
@Singleton
class EpubParserService @Inject constructor(private val epubParser: EpubParser) {
	suspend fun parseEpub(epubFilePath: File): EpubBook = withContext(Dispatchers.IO) {
