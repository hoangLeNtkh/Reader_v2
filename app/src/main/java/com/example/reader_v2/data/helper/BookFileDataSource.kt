...
@Singleton
class BookFileDataSource @Inject constructor(@ApplicationContext private val context: Context) {
	...
	suspend fun saveBookToAppStorage(uri: Uri, bookId: String): File = withContext(Dispatchers.IO) {
	...
	suspend fun extractEpub(epubFile: File, bookId: String) = withContext(Dispatchers.IO) {
